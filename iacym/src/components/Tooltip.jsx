...
export const TooltipContainer = ({ info_redes_sociales }) => {
  ...
  return (
    <div className="tooltip-container hover:text-black">
      <span className="text">
      ...
      {info_redes_sociales.url_tiktok ? (
        <a className="tooltip1" href={info_redes_sociales.url_tiktok} target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
            <path d="M448 209.9a210.1 210.1 0 0 1 -122.8-39.3V349.4A162.6 162.6 0 1 1 185 188.3V278.2a74.6 74.6 0 1 0 52.2 71.2V0l88 0a121.2 121.2 0 0 0 1.9 22.2h0A122.2 122.2 0 0 0 381 102.4a121.4 121.4 0 0 0 67 20.1z" />
          </svg>
        </a>
      ) : (<></>)}
      {info_redes_sociales.url_facebook ? (
        <a className="tooltip2" href={info_redes_sociales.url_facebook} target="_blank" rel="noopener noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
      ...
      {info_redes_sociales.url_wsp ? (
        <a className="tooltip3" href={info_redes_sociales.url_wsp} target="_blank" rel="noopener noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
